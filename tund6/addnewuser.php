<?php
  ...
  if(isset($_POST["submituserdata"])){
	  ...
	  if(empty($firstnameerror) and empty($lastnameerror) and empty($gendererror ) and empty($birthyearerror) and empty($birthmontherror) and empty($birthdateerror) and empty($emailerror) and empty($passworderror) and empty($confirmpassworderror)){
